    ...
    <v-layout row wrap>
      <v-flex xs11 md5>
        ...
        <div>
          <h3>
            Best Buy -
            <i>Contract Worker Level 2 Developer</i>
          </h3>
...
export default Vue.extend({
  data: function() {
    return {
      ...
      bestBuyContent:
        "I took the position at Best Buy after searching in the Minneapolis area for several months. It has provided me with a unique opportunity to dig into new technologies, and have a lot of impact in our small team. The team has been working on a suite of tools to improve developer productivity at Best Buy. This includes a project generation tool built with Yeoman to quickly bootstrap new projects, a set of automation tools built into Jenkins to get new projects into the CI/CD platform, and a robust Jenkins DSL to allow quick integration with the build tools used at Best Buy. I’ve also had the opportunity to proof-of-concept several different technologies, such as a React/Redux front end for our code generator, command line utilities like Vorpal.js to make our tools easier to use, and spring boot starters to make it easier to integrate with Best Buy’s monitoring and metric solutions.",
      isuEducationContent:
